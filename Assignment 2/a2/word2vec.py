...
def naiveSoftmaxLossAndGradient(
    ...
    ### to integer overflow. 
    logits = np.matmul(outsideVectors, np.transpose(centerWordVec))
...
def negSamplingLossAndGradient(
    ...
    loss = -np.log(sigmoid(np.dot(u_o,centerWordVec))) -sum([np.log(sigmoid(-np.dot(outsideVectors[k],centerWordVec))) for k in negSampleWordIndices])
